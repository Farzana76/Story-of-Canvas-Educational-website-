        ...
        <div className="footer">
            <div className="bg3 row">
                ...
                <div className="col-md-6 col-lg-4 col-sm-12 text-light p-3 mt-5 pt-4">
                    ...
                    {/* icon links */}
                    <a target="_blank" rel="noreferrer" href="https://www.facebook.com/canvasacrylicpaintingsbysnm" className="text-light me-2 h3">
                        {element}
                    </a> 
                    <a target="_blank" rel="noreferrer" href="https://www.instagram.com/story_of_canvas_art_by_snm/" className="text-light me-2 h3">
                        {element2}
                    </a>
                    <a target="_blank" rel="noreferrer" href="https://myaccount.google.com/profile" className="text-light h3">
                        {element3}
                    </a>
                </div>
                {/* third column */}
            ...
            <div className="text-light p-2 h5 mb-0 last">
